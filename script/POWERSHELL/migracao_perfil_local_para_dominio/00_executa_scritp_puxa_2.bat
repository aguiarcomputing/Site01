...
powershell -Command "Start-Process powershell -ArgumentList '-File \"D:\VMs\migracao_perfil_local_para_dominio\2_script_useradmin_copia_dominio.ps1"' -Verb RunAs"
